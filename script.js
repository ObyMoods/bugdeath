...
document.getElementById('btnCatboxUpload')?.addEventListener('click', async () => {
  ...
  console.log('RESPONSE CATBOX:', data); // <--- lihat output di console

  if (data.startsWith('http')) {
    msg.textContent = "✅ Upload berhasil!";
    result.innerHTML = `<a href="${data}" target="_blank">${data}</a><br><img src="${data}" style="max-width:100%; margin-top:10px;">`;
  } else {
